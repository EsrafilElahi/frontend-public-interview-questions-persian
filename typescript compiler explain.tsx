...
کامپایل به جاوااسکریپت: تایپ اسکریپت در زمان کامپایل به جاوااسکریپت تبدیل می‌شود. این فرآیند به نام ترنسپایل (transpile) شناخته می‌شود. در نتیجه، اطلاعات تایپی در خروجی نهایی وجود ندارند.
فایل‌های تولید: در محیط تولید، تنها فایل‌های جاوااسکریپت کامپایل شده استفاده می‌شوند. این فایل‌ها از نظر عملکردی با جاوااسکریپت معمولی تفاوتی ندارند.

فقط در توسعه استفاده می‌شود: تایپ اسکریپت برای چک کردن خطاهای تایپی و کامپایل به جاوااسکریپت استفاده می‌شود. در محیط تولید، فایل‌های جاوااسکریپت کامپایل شده استفاده می‌شوند.
حذف در تولید: در فرآیند بیلد، فایل‌های تایپ اسکریپت به جاوااسکریپت تبدیل می‌شوند و خود تایپ اسکریپت در محیط تولید مورد نیاز نیست


کد‌های تایپی مانند type و interface در خروجی نهایی وجود ندارند. در فرآیند کامپایل تایپ اسکریپت، این ساختارهای تایپی به جاوااسکریپت تبدیل می‌شوند و در خروجی نهایی، تنها کد جاوااسکریپت باقی می‌ماند.

چرا در خروجی نهایی نیستند؟
کامپایل به جاوااسکریپت: تایپ اسکریپت از یک کامپایلر استفاده می‌کند که سورس‌کد تایپ اسکریپت را به جاوااسکریپت تبدیل می‌کند. در این فرآیند، اطلاعات تایپی مانند type و interface به جاوااسکریپت تبدیل نمی‌شوند و در خروجی نهایی وجود ندارن
